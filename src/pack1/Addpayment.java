...
public class Addpayment extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(pa, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(payid, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(119, 119, 119))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(49, 49, 49)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String Query ="insert into dbo.payment(PAYMENT_ID, P_DATE, AMOUNT)values('"+payid.getText()+"','"+pad.getText()+"','"+pa.getText()+"') ";
